...
const Home = () => {
  ...
  return (
    ...
    <section
      className="mt-4 dark:bg-gray-100"
    >
      <div
        className="flex flex-col shadow-lg shadow-indigo-500/50
        rounded-md dark:bg-gray-100 justify-center "
      >
        <h1
          className="mt-1 text-center font-palanquin text-8xl 
        ...
        >
         ...
         <h2
          className="font-montserrat text-slate-gray text-center
      text-lg font-bold items-center leading-8 mt-6 mb-10 gap-5"
        >
