...
const Footer = () => {
  return (
    <footer className="bg-gray-500 padding-x mt-10 padding-t pb-8">
      <div className="flex justify-between max-lg:flex-col">
        ...
        text-center"
          ...
          <ul
            className="mt-3 text-2xl font-montserrat 
         leading-normal 
          text-white-400 
          ...
          >
            ...
            <li>
              <Link to={"/manproducts"}>Man Products</Link>
            </li>
            <li>
              <Link to={"/womanproducts"}>Women Products</Link>
            </li>
            <li>
